defmodule Youact.Cache.MemoryBackendTest do
  use ExUnit.Case

  alias Youact.Cache.MemoryBackend
  ...
  describe "cache operations" do
    ...
    test "stores and retrieves activity details", %{state: state} do
      ...
      # Store value
      assert :ok = MemoryBackend.put(channel_id, activity_details, ttl, state)

      # Retrieve value
      assert ^activity_details = MemoryBackend.get(channel_id, state)
    end
