defmodule Youact.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      version: @version,
      name: "Youact",
      description: "A tool to retrieve channel activities from YouTube",
      elixir: "~> 1.15",
  ...
  defp package() do
    [
      ...
      licenses: ["MIT"],
      links: %{"GitHub" => "https://github.com/rsilvestre/youact"}
    ]
  end
end
