defmodule Youact.Cache.MemoryBackend do
  @moduledoc """
  ...
  * `:table_name` - The name of the ETS table to use (defaults to `:youact_cache`)
  * `:max_size` - Maximum number of entries in the cache (defaults to 1000)
  ...
  def validate_positive_integer(value),
    do: {:error, "expected a positive integer, got: #{inspect(value)}"}
