defmodule Youact.Cache.DiskBackend do
  @moduledoc """
  ...
  * `:table_name` - The name of the DETS table to use (defaults to `:youact_disk_cache`)
  * `:cache_dir` - Directory to store the cache files (defaults to "priv/youact_cache")
  * `:max_size` - Maximum number of entries in the cache (defaults to 10,000)
  """

  @behaviour Youact.Cache.Backend

  @default_cache_dir "priv/youact_cache"
  ...
  @options_schema [
    ...
    max_size: [
      type: {:custom, Youact.Cache.MemoryBackend, :validate_positive_integer, []},
